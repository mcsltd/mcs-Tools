...
from sticker import Sticker, Annotation
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--sign", "-s", choices=["sn", "lot"], required=True, type=str)
    # args = parser.parse_args()

    db25var1_create_pdf_dxf(
        path_to_input_txt="../input/task_20-11-2024/sample.txt",
        sign=Sign.sn
    )
